# Q-Trace QA Reports Directory

This directory stores browser QA test runs, UX persona walkthroughs, and visual evidence captures for Q-Trace.
...
- [`images/`](./images/) — Full resolution screenshots and video recording of test beats:
  - `beat1_landing_role_selection.png`
  - `beat2_module_catalogue.png`
  - `beat3_prediction_checkpoint.png`
  - `beat4_circuit_workspace.png`
  - `beat5_run_simulation.png`
  - `beat6_visual_evidence.png`
  - `beat7_quantum_flight_recorder.png`
  - `beat8_repair_challenge.png`
  - `recording.webm` (Full browser execution recording)
